...
!!! note info ""
    ...
    ![Imagen](./img/javier01_128.jpeg){ align=right }

    | |  |  | | | | 
    | :--: | :---: | :--- | :---: | :---: | :---: |
    | :material-account-box: | **Nombre** | Javier Beteta LLuna| :material-email-box: |**Correo** | jbeteta@ieseljust.com | 
    | :material-office-building-marker-outline: | **Centro** | [IES El Just](https://portal.edu.gva.es/iesjaumeeljust/) | :material-code-braces-box: | **Especialidad** | Informática |  

## Módulos 

=== ":fontawesome-solid-code:{ .lg } __DAW__"
    ...
    !!! abstract "" 
        ...
        <div class="grid cards" markdown>
         ...
         -   :fontawesome-solid-at:{ .lg .middle } __Familia Profesional:__ Informática y comunicaciones

            ---
            
            :fontawesome-solid-laptop-code:{ .lg .middle } __Ciclo:__ Desarrollo de aplicaciones web

            :fontawesome-solid-file-pdf:{ .lg .middle } __Currículo:__ [Orden 60/2023](https://dogv.gva.es/es/eli/es-vc/o/2012/09/25/60/dof/vci-spa/pdf) 


        -   :fontawesome-solid-database:{ .lg .middle } __Bases de Datos 0485__

            ---
            
            :fontawesome-solid-clock:{ .lg .middle } __Duración:__ 105 horas 
            
            [Comenzar](https://jbeteta-ies.github.io/BDA/){.md-button .md-button--primary} 

        -   :fontawesome-brands-php:{ .lg .middle } __Desarrollo en entorno del servidor 0613__

            ---

            :fontawesome-solid-clock:{ .lg .middle } __Duración:__ 100 horas 
...
=== ":fontawesome-solid-hexagon-nodes:{ .lg } __ASIX__"
    ...
    !!! abstract ""
        ...
        <div class="grid cards" markdown>
         ...
         -   :fontawesome-solid-at:{ .lg .middle } __Familia Profesional:__ Informática y comunicaciones
            ...
            :fontawesome-solid-laptop-code:{ .lg .middle } __Ciclo:__ Administración de sistemas informáticos y redes

            :fontawesome-solid-file-pdf:{ .lg .middle } __Currículo:__ [Orden 60/2023](https://dogv.gva.es/es/eli/es-vc/o/2012/09/25/60/dof/vci-spa/pdf) 

        -   :fontawesome-solid-server:{ .lg .middle } __Adm. Sist. Gestores de Bases de Datos 0377__
